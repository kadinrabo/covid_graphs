...
def main():
	...
	[dates, recovered_1, recovered_2, recovered_3] = [], [], [], []
	...
	for i in data_1:
		...
		dates.append(date)
		recovered_1.append(i['recovered'])
	for i in data_2:
		recovered_2.append(i['recovered'])
	for i in data_3:
		recovered_3.append(i['recovered'])
	...
	fig, ax = plt.subplots()
	try:
		ax.plot(dates, recovered_1, c='red', linewidth=5)
		ax.plot(dates, recovered_2, c='blue', linewidth=5)
		ax.plot(dates, recovered_3, c='green', linewidth=5)
	except ValueError:
		print("""
...
""")
	...
	plt.title(f'Number of people recovered from COVID-19 in {state_choice_1.upper()}, {state_choice_2.upper()}, and '
