...
def main():
	...
	[dates, positive_1, positive_2, positive_3] = [], [], [], []
	...
	for i in data_1:
		...
		dates.append(date)
		positive_1.append(i['positive'])
	for i in data_2:
		positive_2.append(i['positive'])
	for i in data_3:
		positive_3.append(i['positive'])
	...
	fig, ax = plt.subplots()
	try:
		ax.plot(dates, positive_1, c='red', linewidth=5)
		ax.plot(dates, positive_2, c='blue', linewidth=5)
		ax.plot(dates, positive_3, c='green', linewidth=5)
	except ValueError:
		print("""
...
""")
	...
	plt.title(f'Number of positive COVID-19 cases in {state_choice_1.upper()}, {state_choice_2.upper()}, and '
