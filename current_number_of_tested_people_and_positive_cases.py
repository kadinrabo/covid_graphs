...
def main():
	...
	fig, ax = plt.subplots()
	ax.plot(dates, tested, c='blue', linewidth=5)
	ax.plot(dates, positive, c='red', linewidth=5)
	...
	plt.title(f'Number of people tested and tested positive in {state_choice.upper()} since March 2020\n', fontsize=12)
