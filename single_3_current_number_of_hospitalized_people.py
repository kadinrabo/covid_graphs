...
def main():
	...
	for i in data_1:
		...
		dates.append(date)
		hosp_1.append(i['hospitalized'])
	for i in data_2:
		hosp_2.append(i['hospitalized'])
	for i in data_3:
		hosp_3.append(i['hospitalized'])
	...
	fig, ax = plt.subplots()
	try:
		ax.plot(dates, hosp_1, c='red', linewidth=5)
		ax.plot(dates, hosp_2, c='blue', linewidth=5)
		ax.plot(dates, hosp_3, c='green', linewidth=5)
	except ValueError:
		print("""
...
""")
	...
	plt.title(f'Number of people hospitalized due to COVID-19 in {state_choice_1.upper()}, {state_choice_2.upper()}, and '
			  f'{state_choice_3.upper()} since March 2020\n', fontsize=15)
	plt.xlabel('Date', fontsize=15)
	plt.ylabel('Hospitalizations', fontsize=15)
