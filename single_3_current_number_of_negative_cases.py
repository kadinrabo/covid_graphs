...
def main():
	...
	[dates, negative_1, negative_2, negative_3] = [], [], [], []
	...
	for i in data_1:
		...
		dates.append(date)
		negative_1.append(i['negative'])
	for i in data_2:
		negative_2.append(i['negative'])
	for i in data_3:
		negative_3.append(i['negative'])
	...
	fig, ax = plt.subplots()
	try:
		ax.plot(dates, negative_1, c='red', linewidth=5)
		ax.plot(dates, negative_2, c='blue', linewidth=5)
		ax.plot(dates, negative_3, c='green', linewidth=5)
	except ValueError:
		print("""
...
""")
	...
	plt.title(f'Number of negative COVID-19 cases in {state_choice_1.upper()}, {state_choice_2.upper()}, and '
