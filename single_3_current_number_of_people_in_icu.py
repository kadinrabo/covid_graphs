...
def main():
	...
	for i in data_1:
		...
		dates.append(date)
		icu_1.append(i['inIcuCurrently'])
	for i in data_2:
		icu_2.append(i['inIcuCurrently'])
	for i in data_3:
		icu_3.append(i['inIcuCurrently'])
	...
	fig, ax = plt.subplots()
	try:
		ax.plot(dates, icu_1, c='red', linewidth=5)
		ax.plot(dates, icu_2, c='blue', linewidth=5)
		ax.plot(dates, icu_3, c='green', linewidth=5)
	except ValueError:
		print("""
...
""")
	...
	plt.title(f'Number of people in the ICU due to COVID-19 in {state_choice_1.upper()}, {state_choice_2.upper()}, and '
			  f'{state_choice_3.upper()} since March 2020\n', fontsize=15)
	plt.xlabel('Date', fontsize=15)
	plt.ylabel('In ICU', fontsize=15)
