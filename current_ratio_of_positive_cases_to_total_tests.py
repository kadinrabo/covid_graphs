...
def main():
	...
	plt.grid()
	plt.title(f'Daily ratios of positive cases to total tests in {state_choice.upper()} since March 2020\n',
			  fontsize=12)
	plt.xlabel('Date', fontsize=15)
	plt.ylabel('Ratio (positive cases / total tested)', fontsize=15)
	fig.autofmt_xdate()
