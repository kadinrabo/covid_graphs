...
def main():
	...
	[dates, tested_1, tested_2, tested_3] = [], [], [], []
	...
	try:
		...
		ax.plot(dates, tested_3, c='green', linewidth=5)
	except ValueError:
		print("""
...
""")
	...
	plt.title(f'Number of people tested for COVID-19 in {state_choice_1.upper()}, {state_choice_2.upper()}, and '
