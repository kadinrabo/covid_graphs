...
def main():
	...
	for i in data:
		...
		dates.append(date)
		total_tested.append(i['total'])

	try:
		total_tested.reverse()
		dates.reverse()
	except TypeError:
	...
	fig, ax = plt.subplots()
	ax.plot(dates, total_tested, c='red', linewidth=5)
	ax.set_xticks(dates_list)
	plt.grid()
	plt.title(f'Number of COVID-19 tests done in {state_choice.upper()} since March 2020\n', fontsize=15)
