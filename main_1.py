import argparse
import single_current_number_of_deaths
import single_current_number_of_positive_cases
import single_current_number_of_negative_cases
import single_current_number_of_tested_people
import single_current_number_of_hospitalized_people
import single_current_number_of_people_in_icu
import single_current_number_of_recovered_people
...
""")
		...
		single_current_number_of_deaths.main()
	elif args.positive:
		single_current_number_of_positive_cases.main()
	elif args.negative:
		single_current_number_of_negative_cases.main()
	elif args.tested:
		single_current_number_of_tested_people.main()
	elif args.hospitalized:
		single_current_number_of_hospitalized_people.main()
	elif args.recovered:
		single_current_number_of_people_in_icu.main()
	else:
