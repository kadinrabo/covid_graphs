...
""")
	...
	plt.title(f'Number of negative COVID-19 cases in {state_choice_1.upper()} and {state_choice_2.upper()} since March '
			  f'2020\n', fontsize=15)
	plt.xlabel('Date', fontsize=15)
	plt.ylabel('Negative Cases', fontsize=15)
